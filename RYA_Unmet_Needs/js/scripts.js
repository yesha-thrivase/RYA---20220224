$(function () {
	const sequence = [{
		name: 'RYA_Unmet_Needs', // 0ID of the slide as written in parameters.xml
		...
		name: 'RYA_Unmet_Needs_ref', //1 ID of the slide as written in parameters.xml
		studyDesign: null, // null if there is no study design assigned to this page, the index of the page to link to if there is a study design
		...
		name: 'RYA_ASCIA', //4 ID of the slide as written in parameters.xml
		studyDesign: null, // null if there is no study design assigned to this page, the index of the page to link to if there is a study design
		references: null, // null if there is no reference page assigned to this page, the index of the page to link to if there is a reference page
		backTo:'previous'
	},{
	...
	function createBottomMenu() {
		...
		<div class="unmet_needs" style="width:16.5%"></div>
		...
		$('.bottom-menu .unmet_needs').on('click', function() {
			slideTo(0)
		})
	}
	...
	function topmenu(){
		...
		$('.topmenu').html(`
		<div class = efficacy1" data-prevent-tap="true" style="position:absolute; top : 10%;"></div>
		`)
	}
