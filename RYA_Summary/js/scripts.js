$(function () {
	const sequence = [{
		name: 'RYA_Summary', // ID of the slide as written in parameters.xml
		...
		name: 'RYA_Summary_Ref', // ID of the slide as written in parameters.xml
		studyDesign: null, // null if there is no study design assigned to this page, the index of the page to link to if there is a study design
	...
	function createBottomMenu() {
		...
		<div class="summary"  style="width:12%"></div>
		...
		$('.bottom-menu .summary').on('click', function() {
			slideTo(0)
		})
	}
