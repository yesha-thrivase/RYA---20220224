$(function () {
	const sequence = [{
		name: 'RYA_QOL', //0 ID of the slide as written in parameters.xml
		...
		name: 'RYA_QOL_SD_1', //1 ID of the slide as written in parameters.xml
		...
		name: 'RYA_QOL_SD_2', //2 ID of the slide as written in parameters.xml
		studyDesign: null, // null if there is no study design assigned to this page, the index of the page to link to if there is a study design
		references: null, // null if there is no reference page assigned to this page, the index of the page to link to if there is a reference page
		backTo: 0
	},{
		name: 'RYA_QOL_ref', //3 ID of the slide as written in parameters.xml
		studyDesign: null, // null if there is no study design assigned to this page, the index of the page to link to if there is a study design
		references: null, // null if there is no reference page assigned to this page, the index of the page to link to if there is a reference page
		backTo:0
	},{
		name: 'RYA_QOL_SD_3', // 4 ID of the slide as written in parameters.xml
		studyDesign: null, // null if there is no study design assigned to this page, the index of the page to link to if there is a study design
		references: null, // null if there is no reference page assigned to this page, the index of the page to link to if there is a reference page
		backTo:0
	}
	...
	function createBottomMenu() {
		...
		<div class="qol"  style="width:6.2%"></div>
		...
		$('.bottom-menu .qol').on('click', function() {
			slideTo(0)
		})
	}
	...
	$('.sdnav1').on('click',function(){
		slideTo(4);
	})
	$('.presd').on('click',function(){
		slideTo(1);
	})
